            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/AMDINTEL.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Processor</h5>
                </div>
            </div>
            <!-- Satu Item -->
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">RAM</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/RAM.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">RAM</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/vga2.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">VGA Card</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/casing.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Casing</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/logitech-g402-gaming-mouse.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Mouse</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/keyboard.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Keyboard</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1"><a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i> Lihat Produk Lain nya</a></div>
        </div>
    </div>
    <!-- Categories End -->
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    ...
                    <div class="vendor-item border p-4">
                        <img src="img/rayzen.png" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="img/radeon.png" alt="">
                    </div>
                    <div class="vendor-item border p-4">
